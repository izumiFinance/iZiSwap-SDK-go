...
func InitY2X(liquidities []Liquidity, limitOrders []LimitOrder, currentPoint int) OrderData {
...
func InitX2Y(liquidities []Liquidity, limitOrders []LimitOrder, currentPoint int) OrderData {
	var orderData OrderData
	orderData.Liquidities = liquidities
	orderData.LimitOrders = limitOrders
